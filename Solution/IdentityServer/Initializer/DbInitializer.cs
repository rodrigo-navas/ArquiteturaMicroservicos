    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            ApplicationUser admin = new ApplicationUser()
            {
                ...
                Email = "rodrigo-admin@outlook.com.br",
                EmailConfirmed = true,
            ...
            _user.CreateAsync(admin, "Navas123$").GetAwaiter().GetResult();
            ...
            ApplicationUser client = new ApplicationUser()
            {
                ...
                Email = "rodrigo-client@outlook.com.br",
                EmailConfirmed = true,
                PhoneNumber = "+55 (14) 12345-6789",
                FirstName = "Rodrigo",
                LastName = "Client"
            ...
            _user.CreateAsync(client, "Navas123$").GetAwaiter().GetResult();
